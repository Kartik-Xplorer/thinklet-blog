...
const getRedirectionRules = async () => {
	// Return empty array if required env vars are not set (prevents build failures)
	if (!GQL_ENDPOINT || !host) {
		console.warn('Hashnode environment variables not set, skipping redirection rules');
		return [];
	}
